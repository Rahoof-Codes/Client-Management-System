  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
      ...
      <button
        type="button"
        onClick={toggleTheme}
        className="fixed top-5 right-5 z-50 flex items-center gap-2 px-3.5 py-2 rounded-full glass glass-hover cursor-pointer transition-all duration-300 shadow-sm"
      ...
      {/* Ambient Orbs */}
      <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full opacity-60 animate-float pointer-events-none"
        style={{ background: `radial-gradient(circle, var(--th-orb-1) 0%, transparent 70%)` }} />
      <div className="absolute bottom-[-15%] right-[-10%] w-[400px] h-[400px] rounded-full opacity-50 animate-float pointer-events-none"
        style={{ background: `radial-gradient(circle, var(--th-orb-2) 0%, transparent 70%)`, animationDelay: '3s' }} />
      <div className="absolute top-[40%] right-[15%] w-[250px] h-[250px] rounded-full opacity-40 animate-float pointer-events-none"
